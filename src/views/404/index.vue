<template>
  ...
  .stars, .stars2, .stars3 {
    ...
    height: 100%;
    background-image: 
      radial-gradient(1px 1px at 5% 15%, var(--stars-color) 1%, transparent 2%),
  ...
  .stars2 {
    background-image: 
      radial-gradient(1px 1px at 30% 25%, var(--stars-color) 1%, transparent 2%),
  ...
  .stars3 {
    background-image: 
      radial-gradient(1px 1px at 75% 20%, var(--stars-color) 1%, transparent 2%),
  ...
  &::after {
    ...
    border-radius: 50%;
    background: 
      radial-gradient(circle at 70% 30%, transparent 30%, rgba(0, 0, 0, 0.3) 100%);
  }
}
  ...
  @keyframes spaceship-fly {
    ...
    75% { transform: translateX(-100px) rotate(-5deg); }
