  ...
  <el-card class="weather-card" :class="theme">
    ...
    <div class="weather-content">
        ...
        <div class="current-weather">
          <div class="temp-section">
            ...
            <div class="meta">
              ...
              <span class="range">{{ weatherData.tempRange }}</span>
            </div>
          </div>
          <img
      ...
      <div v-else class="error-message">
        ...
        <el-button class="retry-btn" @click="refreshLocation">重试</el-button>
      </div>
    </div>
  </el-card>
</template>
...
const weatherIcon = (weather) => {
  ...
  return new URL(`/src/assets/weather-icons/${icon}.svg`, import.meta.url).href;
};
