    ...
    <div class="carousel-wrapper">
      ...
      >
        <n-carousel-item
          ...
          :data-index="index"
        >
          <router-link :to="`/article?id=${article.id}`" class="slide-link">
          ...
          <div class="slide-content">
            <router-link :to="`/article?id=${article.id}`" class="handlestyle">
              <h2>{{ article.title }}</h2>
            </router-link>
    ...
    <div class="category-group" role="navigation">
      ...
      >
        ...
        >
          ...
          <svg-icon class="category-button-icon" :name="category.icon" />
...
const articles = ref([
  ...
  },
  {
    ...
    image:
      "https://c4.wallpaperflare.com/wallpaper/393/17/276/technology-code-coding-computer-wallpaper-preview.jpg",
  },
]);
