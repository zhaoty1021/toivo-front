<template>
    <div class="toolbar1" :style="{ right: right }">
        ...
        <el-popover placement="left" trigger="hover" :width="220">
            ...
            <el-tabs v-model="activeName" type="card" class="demo-tabs">
                <el-tab-pane label="公众号" name="first">
                    <el-image :src="defaultSetting.wxOpenImg"> </el-image>
                </el-tab-pane>
                <el-tab-pane label="小程序" name="second">
                    <el-image :src="defaultSetting.appletImg"> </el-image>
                </el-tab-pane>
            </el-tabs>
        </el-popover>
        ...
        <el-tooltip
            ...
            effect="dark"
            :content="
                theme && theme == 'dark' ? '切换浅色主题' : '切换深色主题'
            "
            placement="left"
        >
            <a
            ...
            >
                <i
                    ...
                    id="light"
                    :style="
                        theme == 'dark' ? '' : 'transform: translateX(30px)'
                    "
                ></i>
                <i
