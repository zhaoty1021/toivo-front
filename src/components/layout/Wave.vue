  ...
  <div class="header">
    <div>
      ...
      <svg class="waves" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <g class="parallax">
          <use xlink:href="#gentle-wave" x="48" y="0" fill="var(--wave-color)"/>
          <use xlink:href="#gentle-wave" x="48" y="3" fill="var(--wave-color)"/>
          <use xlink:href="#gentle-wave" x="48" y="5" fill="var(--wave-color)"/>
